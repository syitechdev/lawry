...
<template>
  <div class="flex h-screen flex-col justify-center px-6 py-12 lg:px-8">
    <el-card class="sm:mx-auto sm:w-full sm:max-w-sm" shadow="always">
      <img class="w-[9vw] sm:w-[12vw] mx-auto" src="/public/logo-lawry.png" alt="lawry logo"></img>
      <el-form class="space-y-6">
        <el-form-item class="w-full" label-position="top">
          <template #label>
        ...
        <div class="flex flex-col gap-2">
          <a href="#" class="font-semibold text-sm text-slate-900 hover:text-slate-600 text-center">Mot de passe
            oublié?</a>
          <button type="submit" class="flex w-full justify-center rounded-md bg-red-800 px-3 py-1.5 text-sm/6 font-semibold
